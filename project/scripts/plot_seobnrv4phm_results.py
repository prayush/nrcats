...
def main():
    ...
    if not df_qc.empty:
        ...
        sns.scatterplot(
            data=df_qc, x='q', y='match_22', hue='catalog', style='catalog',
            alpha=0.7, s=50
        )
        plt.yscale('log')
        ...
        sns.scatterplot(
            data=df_qc, x='q', y='mismatch_22', hue='catalog', style='catalog',
            alpha=0.7, s=50
        )
        plt.yscale('log')
    ...
    if not df_ecc.empty:
        ...
        sns.scatterplot(
            data=df_ecc, x='eccentricity', y='mismatch_22', hue='catalog', style='catalog',
            alpha=0.7, s=50
        )
        plt.xscale('log')
        plt.yscale('log')
